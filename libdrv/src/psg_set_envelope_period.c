/*-----------------------------------------------------------------------------+
|                                                                              |
| filename: psg_set_envelope_period.c                                          |
...
/*----------------------------------------------------------------------------*/
/* psg_set_envelope_period()                                                  */
/*----------------------------------------------------------------------------*/
uint8_t psg_set_envelope_period(psgstate_t* pState, uint16_t uiPeriod)
{
  if (pState)
  {
    psg_write_reg(pState, AY8912_REG_ENV_FINE, uiPeriod & 0xFF);
    psg_write_reg(pState, AY8912_REG_ENV_COARSE, uiPeriod >> 8);
    return EOK;
  }
