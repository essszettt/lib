...
uint8_t psg_set_core_fastcall(uint8_t uiCore) __z88dk_fastcall
{
  if (0x03 >= uiCore)
  {
    ...
    uiScratch  = ZXN_READ_REG(REG_PERIPHERAL_2);
    uiScratch &= ~0x03;
    uiScratch |= uiCore; /* 0x00 = YM2149F, 0x01 = AY-3-8912 */
    ZXN_WRITE_REG(REG_PERIPHERAL_2, uiScratch);
